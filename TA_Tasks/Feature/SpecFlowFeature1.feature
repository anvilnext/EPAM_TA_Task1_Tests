...
Scenario Outline: Check Form2
	Given I opened Submit Story Page
	When I fill form with <Name>; <Your E-mail address>; <Town & Country>; <Your telephone number>; <Comments>
	Then I check required field Your E-mail address
	And I check required field Comments
	Then I decide whether to press Send button
Examples: 
	| Name | Your E-mail address | Town & Country | Your telephone number | Comments                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
Scenario Outline: Check Form1
	Given I opened Submit Question Page
	When I fill form1 with <Name>; <Email address>; <Age>; <Postcode>; <What questions would you like us to investigate?>
	Then I check required question field Name
	And I check required question field Email address
	And I check required question field What questions would you like us to investigate?
